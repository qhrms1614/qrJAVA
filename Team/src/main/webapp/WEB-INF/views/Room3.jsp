        ...
        <section class="about-section text-center" id="about">
            <div class="container px-4 px-lg-5">
                <div class="row gx-4 gx-lg-5 justify-content-center">
                    <div class="col-lg-8">
<div class="sub_title">
	<h1 class="text-white mb-4">Suite Room</h1>
</div>
...
<div class="depth3">
	<ul>
		...
		<li class="on"><a href="/team/Room3">Suite</a></li>
		<li><a href="/team/Room4">Hollywood</a></li>
	</ul>
		<img class=roomimg src="https://cdnb.artstation.com/p/assets/images/images/011/879/705/large/berktan-hatiboglu-albarella-sahne.jpg?1531902169" alt="" />
	<div class="slide_text"><br>
		<p class="text-white-50">럭셔리한 인테리어와 개방감이 돋보이는 공간입니다.<br>
		특히 주니어스위트 테라스 객실에서는 밝고 환한 아라뱃길의 전망과 분위기는 물론<br>
		주말 야간에 펼쳐지는 화려한 불꽃놀이를 감상하실 수 있습니다.         </p>
	</div>
</div> 
	                    </div>
                </div>
	...
	<tbody><tr>
      ...
      <td>
         ...
         <p>
            ...
            <span class="con">72㎡ / 83㎡</span>
         </p>
         <p>
            <span class="title">객실구성</span>
            <span class="con">침실1, 거실1, 욕실2, 테라스1(욕조 포함)</span>
         </p>
         <p>
