        ...
        <section class="about-section text-center" id="about">
            <div class="container px-4 px-lg-5">
                <div class="row gx-4 gx-lg-5 justify-content-center">
                    <div class="col-lg-8">
<div class="sub_title">
	<h1 class="text-white mb-4">Hollywood Room</h1>
</div>
...
<div class="depth3">
	<ul>
		...
		<li class="on"><a href="/team/Room4">Hollywood</a></li>
	</ul>
		<img class=roomimg src="https://cdna.artstation.com/p/assets/images/images/011/616/862/large/berktan-hatiboglu-vidor-yatak1.jpg?1530516817" alt="" />
	<div class="slide_text"><br>
		<p class="text-white-50">누구에게나 특별함이 필요한 날이 있습니다. 가족, 친구, 연인, 모두와 함께 하세요.<br>
			휴먼 호텔이, 당신이 행복한 모든 순간에 가장 빛나는 시간, 가장 아름다운 추억을 약속 드립니다.         </p>
	</div>
</div>
					</div>
				</div>
	...
	<tbody><tr>
      ...
      <td>
         ...
         <p>
            ...
            <span class="con">92㎡ / 103㎡</span>
         </p>
         <p>
            <span class="title">객실구성</span>
            <span class="con">침실2, 거실1, 욕실2, 테라스1(욕조 포함)</span>
         </p>
         <p>
