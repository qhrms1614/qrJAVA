...
<style>
bxslider@charset "utf-8";
@import url('https://fonts.googleapis.com/css?family=Noto+Serif+KR:500&display=swap');

body{width:100%}
#wrap{width:100%; min-width:1760px; margin:0 auto; overflow:hidden;  max-width:1920px;}
#header{width:100%;min-width:1760px;}
#container{width:100%; min-width:1760px; }
#contents{width:100%; min-width:1760px;  margin:0 auto 0; overflow:hidden; position:relative; }
        ...
        <section class="about-section text-center" id="about">
            <div class="container px-4 px-lg-5">
                <div class="row gx-4 gx-lg-5 justify-content-center">
                    <div class="col-lg-8">
<div class="sub_title">
	<h1 class="text-white mb-4">Standard Room</h1>
</div>

<div class="depth3">
	<ul>
		<li class="on"><a href="/team/Room1">Standard</a></li>
		<li><a href="/team/Room2">Business</a></li>
		<li><a href="/team/Room3">Suite</a></li>
		<li><a href="/team/Room4">Hollywood</a></li>
	</ul>
		<img class=roomimg src="https://cdna.artstation.com/p/assets/images/images/014/081/626/large/berktan-hatiboglu-modern-render1.jpg?1542377257" alt="" />
		<div class="slide_text"><br>
			<p class="text-white-50">편안함이 감싸고 있는 누구에게도 방해받지 않는 공간<br>
				평범한 일상을 벗어난 모던하고 세련된 인테리어로 쉼을 완성 합니다.</p>
		</div>
	</div>
                    </div>
                </div>
	...
	<tbody><tr>
		...
		<td>
			...
			<p>
				...
				<span class="con">22㎡ / 23㎡</span>
			</p>
			<p>
				<span class="title">객실구성</span>
				<span class="con">침실1, 욕실1</span>
			</p>
			<p>
